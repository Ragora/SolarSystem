...
namespace SolarSystem
{
    ...
    public class AnimatedSprite : IDrawable, ITickable
    {
        ...
        public RenderTarget2D CurrentFrameTexture;
        ...
        public virtual void Initialize()
        {
            ...
            CurrentFrameTexture = new RenderTarget2D(InternalGame.GraphicsDevice, FrameSize.X, FrameSize.Y);
        }
        ...
        public virtual void Update(GameTime time)
        {
            ...
            if (TimeSinceLastFrame >= MillisecondsPerFrame)
            {
                ...
                // Every time we update the frame to draw, update the render target to reflect this
                InternalGame.GraphicsDevice.SetRenderTarget(CurrentFrameTexture);
                InternalGame.GraphicsDevice.Clear(Color.Red);

                SpriteBatch batch = new SpriteBatch(InternalGame.GraphicsDevice);
                ...
                InternalGame.GraphicsDevice.SetRenderTarget(null);
            }
        }
